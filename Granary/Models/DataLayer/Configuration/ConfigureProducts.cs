...
internal class ConfigureProducts : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> entity)
    {
        ...
        entity.HasData(
            ...
            new Product { ProductId = 2, ProductName = "Roma Tomatoes", UnitType = "Pound", StockQuantity = 200.00m, Description = "Ideal for sauces", CategoryId = 1, SupplierId = 4 },
            new Product { ProductId = 3, ProductName = "Beefsteak Tomatoes", UnitType = "Pound", StockQuantity = 150.00m, Description = "Large slicing tomato", CategoryId = 1, SupplierId = 4 },

            new Product { ProductId = 4, ProductName = "White Mushrooms", UnitType = "Pound", StockQuantity = 80.00m, Description = "Mild and versatile", CategoryId = 2, SupplierId = 3 },
            ...
            new Product { ProductId = 6, ProductName = "Shiitake Mushrooms", UnitType = "Pound", StockQuantity = 300.00m, Description = "Savory and rich flavor", CategoryId = 2, SupplierId = 3 },
            ...
            new Product { ProductId = 8, ProductName = "Red Onions", UnitType = "Pound", StockQuantity = 400.00m, Description = "Colorful and sharp", CategoryId = 3, SupplierId = 5 },
