...
public class ConfigureInvoiceProducts : IEntityTypeConfiguration<InvoiceProduct>
{
    public void Configure(EntityTypeBuilder<InvoiceProduct> entity)
    {
        ...
        entity.HasData(
            ...
            new InvoiceProduct { InvoiceId = 1, ProductId = 2, Quantity = 15.00m, UnitPrice = 1.49m },

            // Invoice 2
            new InvoiceProduct { InvoiceId = 2, ProductId = 3, Quantity = 40.00m, UnitPrice = 1.25m },
            new InvoiceProduct { InvoiceId = 2, ProductId = 4, Quantity = 20.00m, UnitPrice = 3.25m },

            // Invoice 3
            new InvoiceProduct { InvoiceId = 3, ProductId = 5, Quantity = 10.00m, UnitPrice = 1.99m },
            new InvoiceProduct { InvoiceId = 3, ProductId = 6, Quantity = 12.00m, UnitPrice = 0.75m },

            // Invoice 4
            new InvoiceProduct { InvoiceId = 4, ProductId = 7, Quantity = 18.00m, UnitPrice = 1.49m },
            new InvoiceProduct { InvoiceId = 4, ProductId = 8, Quantity = 22.00m, UnitPrice = 1.25m },

            // Invoice 5
            new InvoiceProduct { InvoiceId = 5, ProductId = 9, Quantity = 50.00m, UnitPrice = 0.89m },
            new InvoiceProduct { InvoiceId = 5, ProductId = 10, Quantity = 30.00m, UnitPrice = 1.10m }
        );
    }
}
